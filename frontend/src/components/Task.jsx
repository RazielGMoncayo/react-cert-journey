...
// this function is a component and show a title and a button 
    ...
    return (
        <>
            ...
            <button onClick={handleClick}>
                {(completed) ? "Completed" : "Click me"} {/* button text according the completed value - Conditional rendering  */}
            </button> 
        </>
    )
}